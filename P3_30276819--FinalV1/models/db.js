...
db.serialize(() => {
   ...
   db.run('CREATE TABLE IF NOT EXISTS calificaciones (cliente_id INTEGER, producto_id INTEGER, calificacion INTEGER, PRIMARY KEY (cliente_id, producto_id), FOREIGN KEY (cliente_id) REFERENCES clientes (rowid), FOREIGN KEY (producto_id) REFERENCES productos (rowid))');
});
